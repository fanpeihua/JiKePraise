...
public class ThumbUpView extends LinearLayout implements View.OnClickListener {
    ...
    public ThumbUpView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mDrawablePadding = typedArray.getDimension(R.styleable.ThumbUpView_tuv_drawable_padding,
                ThumbUtils.dip2px(context, DEFAULT_DRAWABLE_PADDING));
        mCount = typedArray.getInt(R.styleable.ThumbUpView_tuv_count, 0);
        mTextColor = typedArray.getColor(R.styleable.ThumbUpView_tuv_text_color,
                Color.parseColor(CountView.DEFAULT_TEXT_COLOR));

        mTextSize = typedArray.getDimension(R.styleable.ThumbUpView_tuv_drawable_padding,
                ThumbUtils.sp2px(context, CountView.DEFAULT_TEXT_SIZE));
    ...
    public ThumbUpView setTextSize(float textSize) {
    ...
    protected void onRestoreInstanceState(Parcelable state) {
        ...
        mTextSize = data.getFloat("textSize", ThumbUtils.sp2px(getContext(), CountView.DEFAULT_TEXT_SIZE));
        mTextColor = data.getInt("textColor", Color.parseColor(CountView.DEFAULT_TEXT_COLOR));
        mIsThumbUp = data.getBoolean("isThumbUp", false);
        mDrawablePadding = data.getFloat("drawablePadding", ThumbUtils.sp2px(getContext(), DEFAULT_DRAWABLE_PADDING));
        init();
    }
}
